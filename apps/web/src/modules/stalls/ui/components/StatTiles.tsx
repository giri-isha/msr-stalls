...
export const GLYPH: Record<string, string> = {
  All: 'clipboard-list',
  Submitted: 'file-text',
  Shortlisted: 'list-view',
  Selected: 'circle-check',
  Backup: 'clock',
  Rejected: 'ban',
  Cancelled: 'ban',
  Flagged: 'alert-triangle',
  'Bank Form Sent': 'message-square',
  'Bank Form Filled': 'check-square',
  'Payment Sent': 'message-square',
  'Payment Confirmed': 'circle-check',
  'FSSAI Pending': 'alert-triangle',
  Ready: 'circle-check',
  'Checked In': 'log-in',
  Pending: 'clock',
  Confirmed: 'circle-check',
  Vendor: 'users',
  'Local Welfare': 'heart-handshake',
  Ashram: 'home',
  'Ashram Food': 'home',
};
